...
$web->appendContent("<p class='encadretitle'> <img class = 'posterepisode' src=poster.php?posterId={$season->getPosterId()}>{$web::escapeString($season->getName())}-<a href='season.php?tvshowId={$tvshow->getId()}'> {$web::escapeString($tvshow->getName())}</a></p>");
